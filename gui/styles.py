...
class Styles:
    ...
    # Additional fonts
    HEADER_FONT = QFont('Ubuntu', 12, QFont.Weight.Bold)
    BODY_FONT = QFont('Ubuntu', 10)
    SMALL_FONT = QFont('Ubuntu', 9)
    ...
    def setup_application_style(app):
        ...
        app.setStyleSheet(f"""
            ...
            QWidget:not(QSpinBox):not(QDoubleSpinBox) {{
                background-color: {Styles.DARK_BG};
                color: white;
                {Styles.FONT_STYLE}
            }}
            QLineEdit {{
                ...
                padding: 12px 8px;
                min-height: 30px;
                selection-background-color: {Styles.PRIMARY_LIGHT};
                margin: 4px 0;
                font-size: 14px;
            }}
            QLineEdit:focus {{
                border-color: {Styles.PRIMARY_LIGHT};
            }}
            QLineEdit:disabled {{
                color: #7f7f7f;
                background-color: {Styles.SURFACE_DARK};
                border-color: {Styles.SURFACE_LIGHT};
            }}
            QGroupBox {{
                border: 2px solid {Styles.PRIMARY};
                border-radius: 5px;
